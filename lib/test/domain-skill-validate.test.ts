...
describe('validateSkillName', () => {
  ...
  it('rejects missing name', () => {
    ...
    expect(validateSkillName(null as unknown as string)).toBe('name is required and must be a string');
    expect(validateSkillName(undefined as unknown as string)).toBe('name is required and must be a string');
  });

  it('rejects non-string name', () => {
    expect(validateSkillName(123 as unknown as string)).toBe('name is required and must be a string');
    expect(validateSkillName({} as unknown as string)).toBe('name is required and must be a string');
  });
...
describe('validateSkillDescription', () => {
  ...
  it('rejects missing description', () => {
    ...
    expect(validateSkillDescription(null as unknown as string)).toBe('description is required and must be a string');
    expect(validateSkillDescription(undefined as unknown as string)).toBe('description is required and must be a string');
  });

  it('rejects non-string description', () => {
    expect(validateSkillDescription(123 as unknown as string)).toBe('description is required and must be a string');
  });
