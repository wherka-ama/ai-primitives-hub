 ...
 * functions (migration plan §7.5, Phase 4 item 3, slice 1) — kept as a class
 * with static methods so existing call sites across the extension are
 * unchanged. The original's debug/warn diagnostic logging on fallback paths
