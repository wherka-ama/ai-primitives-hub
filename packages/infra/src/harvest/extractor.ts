 ...
 * `infra/src/harvest/extractor.ts`; `BundleManifest`/`BundleRef`/
 * `HarvestedFile`/`Primitive`/`PrimitiveKind` now live directly in
 * `@ai-primitives-hub/core` rather than a `search/types` re-export layer.
 * @module harvest/extractor
 */
