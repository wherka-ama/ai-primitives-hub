 ...
 *
 * Ported unchanged from the reference branch's `infra/src/search/bm25-engine.ts`.
 * No dedicated upstream unit test exists for this file — it is covered
 * transitively via `primitive-index.test.ts`'s end-to-end search queries.
 * @module search/bm25-engine
 */
