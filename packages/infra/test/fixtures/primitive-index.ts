 ...
 *
 * Shared across `harvest/harvester.test.ts` and (once ported) the
 * `search/*` test suite — both need a small, deterministic
 * `BundleProvider` with realistic-looking manifest items and file
 * content.
 */
...
export class FakeBundleProvider implements BundleProvider {
  ...
  // eslint-disable-next-line @typescript-eslint/require-await -- async required by BundleProvider interface; this implementation is sync.
