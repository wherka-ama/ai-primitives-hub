 ...
 * `app/test/discovery/app-discovery-recommendation-engine.test.ts`.
 * @module test/discovery/recommendation-engine
 */
...
describe('RecommendationEngine', () => {
  ...
  // Deliberately loosely typed to match the reference: reassigned per test
  // with vi.fn() mocks (isAvailable/createSession), and later tests pass
  // additional inline SDK-shaped objects directly to the constructor.
